...
if __name__ == "__main__":
    ...
    with open('arrival_rate_results_multiple_groupsupdated.pkl', 'wb') as f:
        pickle.dump(results, f)
    
    with open('arrival_rate_results_multiple_groupsupdated.json', 'w') as f:
    ...
    print(f"\nResults saved to 'arrival_rate_results_multiple_groups.pkl' for Jupyter plotting")